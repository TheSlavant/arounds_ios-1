...
class PushNotification {
    ...
    func sendNotificationWithBadge(chatRoomId: String = "", username: String = "", type: Int = 1, handler: String = "", badge: Int = 0, sound: String = NotificationRingTone.default.filename, reciverToken: String, body: String, title: String) {
        ...
        let headers = ["Content-Type": "application/json", "Authorization": "key=AAAAwLVQS4E:APA91bEx09e5lvOUHQGiQ58RA0zGN3HyiuvUJJvPRvqPVFHK1p_92DoFW-KuGsLBV2CRiXC9GJgYRfBzY69A_zrcc2kTlegOsDJK8_RAct5aO0bo6psI8eMWxwU4tpXQ6R500xIAEIw_"]
