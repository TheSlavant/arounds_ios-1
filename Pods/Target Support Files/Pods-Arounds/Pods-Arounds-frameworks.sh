...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseUtils/FirebaseUtils.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GCCountryPicker/GCCountryPicker.framework"
